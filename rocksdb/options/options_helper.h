...
static std::unordered_map<std::string, OptionTypeInfo> db_options_type_info = {
    ...
    {"allow_defer_compaction",
     {offsetof(struct DBOptions, allow_defer_compaction),
      OptionType::kBoolean, OptionVerificationType::kNormal, false, 0}},
    {"rw_ratio_window_size",
     {offsetof(struct DBOptions, rw_ratio_window_size),
      OptionType::kUInt64T, OptionVerificationType::kNormal, false, 0}},
    {"enable_compaction_threshold",
     {offsetof(struct DBOptions, enable_compaction_threshold),
      OptionType::kDouble, OptionVerificationType::kNormal, false, 0}},
    {"disable_compaction_threshold",
     {offsetof(struct DBOptions, disable_compaction_threshold),
      OptionType::kDouble, OptionVerificationType::kNormal, false, 0}},
